...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /* Escreva um programa Java para definir um período de tempo usando
           valores baseados em data (Period) e uma duração de tempo usando valores
           baseados em tempo (Duration). */
